...
@register(outgoing=True, pattern="^.fckyal$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("eemmmmmm.....")
        await e.edit("Gini")
        await e.edit("Gua")
        await e.edit("Gua Cuman")
        await e.edit("Gua Cuman Mau")
        await e.edit("Gua Cuman Mau Bilang")
        await e.edit("Untuk")
        ...
        await e.edit("FUCK Y")
        await e.edit("FUCK Y'")
        await e.edit("FUCK Y'A")
        await e.edit("FUCK Y'AL")
        await e.edit("FUCK Y'ALL")
        await e.edit("FUCK Y'ALL.")
        await e.edit("FUCK Y'ALL..")
        await e.edit("FUCK Y'ALL...")
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("`Hai Anak Pungut 🙈, Jangan Lupa Makan Yaa`")
    sleep(1)
