...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/skuyykek69/KEK-UserBot"
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("**Mematikan KEK-Userbot....**")
...
async def killdabot(event):
    await event.edit("**Restarting KEK-Userbot...**")
